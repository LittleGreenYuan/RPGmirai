...
class UserData {
    ...
    companion object{
        ...
        suspend fun Botload(){
            ...
            /*
            val bot = BotFactory.newBot(UserData.RootList[0].toLong(), UserData.RootList[1].toString()) {
                fileBasedDeviceInfo() // 使用 device.json 存储设备信息
                //protocol = ANDROID_WATCH
                //protocol = ANDROID_PAD // 切换协议
                protocol = BotConfiguration.MiraiProtocol.ANDROID_PHONE
            }.alsoLogin()*/
            //YuanBot.bot.getFriend(RootList[2].toLong())?.sendMessage("System online!")//加载bot
